...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        log.info("createRestApi，设置项目路径：com.yhf.service02，访问路径：http://localhost:8062/service02/swagger-ui.html");
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.yhf.service02"))//设置项目路径
